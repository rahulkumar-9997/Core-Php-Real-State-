...
<html>
  <head>
    ...
    <title><?php echo $_SESSION['title'].": All Agent List"; ?></title>
        ...
        <section class="content">
          ...
          <div class="box box-info SeaechAgentList">
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT agency_code, id, branch_id, agent_name, country, state, district, post, pin_code, address, mobile_no, c_date, email FROM agent WHERE status=1";
                ...
                <a href="exportAgentList.php?token=<?php echo $_REQUEST['token'];?>" class="btn btn-info btn-xs"> <i class="fa fa-file-archive-o"></i> Export to excel</a>
                </div>
              </div>
