...
<html>
  <head>
    ...
    <title><?php echo $_SESSION['title'].":RD (Recurring Deposit)Customer List"; ?></title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="">RD (Recurring Deposit) Customer List</li>
          </ol>
        </section>
        <!-- Main content -->
        <section class="content">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-user-list"></i>RD (Recurring Deposit) Customer</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT cu.id, cu.customer_id, cu.registration_no, cu.claimed_maturity_payment_status, cu.sr_no, cu.agency_code,"
                                    ...
                                    . " cpm.commision_in_per, cpm.plan_id, cpm.interest_rate_in_per, cpm.plan_type, cpm.pay_mode, "
                                    . "cpm.installment_amount, cpm.maturity_return, ach.id, ach.agency_code, ach.customer_id "
                                    . "FROM customer AS cu, customer_plan_mapping AS cpm, agent_commission_history AS ach WHERE cpm.customer_id = ach.customer_id AND cpm.customer_id = cu.customer_id AND cu.status=1 AND ach.status=1 AND cpm.status=1 AND cpm.plan_type='RD' group by cu.customer_id DESC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                            /*if($row['no_of_installment']!==$row['no_of_pay_installment'] OR $row['claimed_maturity_payment_status']==0){
                                            ?>
                                            <a href="../installment/depositInstallmentWithTransactionId.php?cuId=<?php echo $row['customer_id'];?>&planId=<?php echo $row['plan_id'];?>&cuName=<?php echo $row['name'];?>&token=<?php echo $_REQUEST['token'];?>" class="btn btn-info btn-xs deldp" title="Pay Installment"><i class="fa fa-rupee"></i> Pay Installment</a>
                                            <?php
                                            }else{
                                             ?>
                                            <a href="#" class="btn btn-bitbucket btn-xs" data-toggle="tooltip" title="Paid MIS"><i class="fa fa-rupee"></i> Paid MIS</a>
                                            <?php
                                            }*/
                                            ?>
                ...
                <a href="exportRdCustomerList.php?token=<?php echo $_REQUEST['token'];?>" class="btn btn-info btn-xs"> <i class="fa fa-file-archive-o"></i> Export to excel</a>
                <?php
                }else{
                ?>    
                <table id="example1" class="table table-bordered table-striped">
