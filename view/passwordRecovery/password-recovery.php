  ...
  <body class="hold-transition login-page bg">
    <div class="login-box">
      ...
      <div class="box-header with-border">
            <h3 class="box-title text-danger">Enter Following Detail</h3>
      ...
      <div class="login-box-body" style="margin-top: -30px;">
        ...
        <form action="recoveryController.php" method="post">
          <div class="form-group has-feedback">
              <input type="text" name="email" required="required" class="form-control" placeholder="Enter your registered email id">
